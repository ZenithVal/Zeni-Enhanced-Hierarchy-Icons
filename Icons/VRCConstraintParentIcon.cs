...
namespace EnhancedHierarchy.Icons {
    public sealed class VRCConstraintParentIcon : IconBase {
        ...
        public override string Name { get { return "VRChat Parent Constraint Icon"; } }
        public override float Width { get { return hasComponent ? 15f : 0f; } }
        public override IconPosition Side { get { return IconPosition.All; } }

        public override Texture2D PreferencesPreview { get { return Resources.Load<Texture2D>("VRC_ParentConstraint Icon"); } }
        ...
        public override void Init() {
            ...
            for (var i = 0; i < components.Count; i++)
                if (components[i] is VRCParentConstraint) {
                    hasComponent = true;
                    break;
                }
        }
