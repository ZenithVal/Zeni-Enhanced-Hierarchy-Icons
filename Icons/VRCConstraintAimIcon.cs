...
namespace EnhancedHierarchy.Icons {
    public sealed class VRCConstraintAimIcon : IconBase {
        ...
        public override string Name { get { return "VRChat Aim Constraint Icon"; } }
        public override float Width { get { return hasComponent ? 15f : 0f; } }
        public override IconPosition Side { get { return IconPosition.All; } }

        public override Texture2D PreferencesPreview { get { return Resources.Load<Texture2D>("VRC_AimConstraint Icon"); } }
        ...
        public override void Init() {
            ...
            for (var i = 0; i < components.Count; i++)
                if (components[i] is VRCAimConstraint) {
                    hasComponent = true;
                    break;
                }
        }
